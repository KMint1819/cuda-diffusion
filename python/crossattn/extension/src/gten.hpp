...
{
extern std::unique_ptr<torch::nn::LinearImpl> layer_to_q;
extern std::unique_ptr<torch::nn::LinearImpl> layer_to_k;
extern std::unique_ptr<torch::nn::LinearImpl> layer_to_v;
extern std::unique_ptr<torch::nn::LinearImpl> layer_to_out;
extern std::unique_ptr<torch::nn::DropoutImpl> layer_dropout;
} // namespace CrossAttention
